<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Widgets</a>

                    <a href="{{route('product.url')}}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Product</a>
